...
private:
    ...
    {
 /*       juce::Colour::fromFloatRGBA(0.55f, 0.3f, 0.8f, 1.0f),
        ...
        juce::Colour::fromFloatRGBA(0.35f, 0.10f, 0.60f, 1.0f),
        juce::Colour::fromFloatRGBA(0.34f, 0.09f, 0.59f, 1.0f),
        juce::Colour::fromFloatRGBA(0.33f, 0.08f, 0.58f, 1.0f),
        juce::Colour::fromFloatRGBA(0.32f, 0.07f, 0.57f, 1.0f),
        juce::Colour::fromFloatRGBA(0.31f, 0.06f, 0.56f, 1.0f),
        juce::Colour::fromFloatRGBA(0.30f, 0.05f, 0.55f, 1.0f),
        juce::Colour::fromFloatRGBA(0.29f, 0.04f, 0.54f, 1.0f),
        juce::Colour::fromFloatRGBA(0.28f, 0.03f, 0.53f, 1.0f),
        juce::Colour::fromFloatRGBA(0.27f, 0.02f, 0.52f, 1.0f),
        juce::Colour::fromFloatRGBA(0.26f, 0.01f, 0.51f, 1.0f),
        juce::Colour::fromFloatRGBA(0.25f, 0.0f, 0.50f, 1.0f),
        juce::Colour::fromFloatRGBA(0.24f, 0.0f, 0.49f, 1.0f),*/
